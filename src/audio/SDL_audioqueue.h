...
// Create a new audio track using the specified buffer
...
// Read and convert data from the queue's past, present, and future.
...
// Resets the audio queue history to the specified number of frames, filled with silence
